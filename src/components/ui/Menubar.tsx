...
const MenubarSubContent = React.forwardRef<React.ElementRef<typeof MenubarPrimitive.SubContent>, MenubarProps>(
    ({ className, ...props }, ref) => (
...
const MenubarContent = React.forwardRef<React.ElementRef<typeof MenubarPrimitive.Content>, MenubarProps & {
...
const MenubarShortcut: React.FC<MenubarShortcutProps> = ({ className, ...props }) => (

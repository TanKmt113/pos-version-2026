...
export function UnitsForm({ initialData, mode }: UnitsFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.uomCode.trim()) {
      toast.error('Vui lòng nhập mã đơn vị tính');
      return;
    }
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, uomCode: e.target.value })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, uomName: e.target.value })
                  }
                  disabled={loading}
                  required
                />
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm">
                <div>
                  ...
                  <p className="font-medium">{initialData.creator}</p>
                </div>
                <div>
                ...
                {initialData.updator && (
                  <>
                    <div>
                      <p className="text-muted-foreground">Người cập nhật</p>
                      <p className="font-medium">{initialData.updator}</p>
                    </div>
                    <div>
